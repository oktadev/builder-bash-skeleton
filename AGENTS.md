...
> Auto-loaded by OpenAI Codex, Cursor, and other agentic tools that
> recognise this filename. Treat as durable instructions for any session
> in this repository.
>
> **Kit version: v3.**
...
- **`offline_access` on Step 0 / Step 0b.** Assert it came back. A
  missing refresh token surfaces ten minutes later as a mystery
  `invalid_grant`.
- **PKCE S256.** Never `plain`. Verifier and challenge base64url
